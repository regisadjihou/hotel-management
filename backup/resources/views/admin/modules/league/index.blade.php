    ...
    <div class="col-12">
        <div class="card">
            <div class="border-bottom title-part-padding">
                <h4 class="card-title mb-0" style="display: inline-block;">Leagues List</h4>
                <a href="{{route('admin.league.create')}}" style="float:right;"><button class="btn btn-success">Insert New League</button></a>
            </div>
            <div class="card-body">
