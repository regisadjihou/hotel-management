    ...
    <div class="col-12">
        <div class="card">
            <div class="border-bottom title-part-padding">
                <h4 class="card-title mb-0" style="display: inline-block;">Country Teams List</h4>
                <a href="{{route('admin.country-team.create')}}" style="float:right;"><button class="btn btn-success">Insert New Country Team</button></a>
            </div>
            <div class="card-body">
