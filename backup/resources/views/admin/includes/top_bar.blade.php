                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{asset('frontend/assets/img/logo/logo.PNG')}}" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                            <img src="{{asset('frontend/assets/img/logo/logo.PNG')}}" alt="homepage" class="light-logo" style="width:200px;" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
