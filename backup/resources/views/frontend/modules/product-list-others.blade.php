            ...
            <div class="col-lg-3 order-lg-1">
                <div class="shop-sidebar-wrap clearfix pb-md-65">
                    <div class="shop-sidebar mb-30">
                        <h4 class="title mb-20">Sub Categories</h4>
...
<script>
    $(document).ready(function () {
        ...
        function category_filter()
        {
            ...
            $.ajax({
                url: "{{route('product-filter-others')}}",
                type: 'GET',
                data: {category:$('#category').val(),sub_category:$('#subcategory').val(),min_price: $('#min').val(),max_price: $('#max').val(),sortby: sortBy},
